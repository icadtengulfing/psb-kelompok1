...
<head>
    ...
    <title>Daftar Siswa Admin Website SMK - PSB</title>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-[3fr_1fr] gap-4 lg:gap-8 mb-8">
                <div
                    ...
                    <p class="text-lg lg:text-2xl text-[var(--txt-primary)] mt-0 lg:mt-2">
                        List Calon Siswa yang terdaftar di Website
                    </p>
                </div>
                        ...
                        <form class="w-full">
                            <div class="mb-4">
                                ...
                                <input type="text" id="namaLengkap"
                                    class="bg-transparent border border-[var(--txt-primary)]/30 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:border-[var(--bg-primary2)] block w-full p-2 ps-3"
                                    placeholder="Masukkan Nama Lengkap" required value="Abdul Ghaniyy Albar" />
                            </div>
                            <div class="mb-4">
                                <label for="id_pendaftar" id="disabled-input" aria-label="disabled input"
                                    class="block mb-2 text-lg font-medium text-[var(--txt-primary)]">
                                    id_pendaftar:
                                </label>
                                <input type="number" id="id_pendaftar"
                                    ...
                                    placeholder="Id Pendaftar" required value="1" disabled />
                            </div>
                            <div class="mb-4">
                                <label for="id_jalur" id="disabled-input" aria-label="disabled input"
                                    class="block mb-2 text-lg font-medium text-[var(--txt-primary)]">
                                    id_jalur:
                                </label>
                                <input type="number" id="id_jalur"
                                    class="bg-[var(--bg-primary2)]/20 hover:bg-[var(--bg-primary2)]/30 border border-[var(--txt-primary)]/30 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:border-[var(--bg-primary2)] block w-full p-2 ps-3 cursor-not-allowed"
                                    placeholder="Id Jalur" required value="1" disabled />
                            </div>
                            <div class="mb-4">
                                <label for="NISN" class="block mb-2 text-lg font-medium text-[var(--txt-primary)]">
                                    NISN:
                                ...
                                <input type="number" id="NISN"
                                    class="bg-transparent border border-[var(--txt-primary)]/30 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:border-[var(--bg-primary2)] block w-full p-2 ps-3"
                                    placeholder="Masukkan NISN Siswa" required value="1234567890" />
                            </div>
                            <div class="mb-4">
                                <label for="NIK" class="block mb-2 text-lg font-medium text-[var(--txt-primary)]">
                                    NIK:
                                ...
                                <input type="number" id="NIK"
                                    class="bg-transparent border border-[var(--txt-primary)]/30 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:border-[var(--bg-primary2)] block w-full p-2 ps-3"
                                    placeholder="Masukkan NIK Siswa" required value="1234567890" />
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="text" id="asalSekolah"
                                    class="bg-transparent border border-[var(--txt-primary)]/30 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:border-[var(--bg-primary2)] block w-full p-2 ps-3"
                                    placeholder="Masukkan Asal Sekolah" required value="SMP Pamulang, Jauh Pake Helm" />
                            </div>
                            <div class="mb-4">
                                <label for="alamat" class="block mb-2 text-lg font-medium text-[var(--txt-primary)]">
                                    Alamat:
                                ...
                                <input type="alamat" id="alamat"
                                    class="bg-transparent border border-[var(--txt-primary)]/30 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:border-[var(--bg-primary2)] block w-full p-2 ps-3"
                                    placeholder="Masukkan Alamat" required value="Jalan Puri Mawar IV Blok D5 No. 3, Kelurahan Pamulang Barat, Pamulang (Rumah kedua), KOTA TANGERANG SELATAN, PAMULANG, BANTEN, ID, 15417" />
                            </div>
                            <div class="mb-4">
                                <label for="tempatTanggalLahir"
                                    class="block mb-2 text-lg font-medium text-[var(--txt-primary)]">
                                ...
                                <input type="text" id="tempatTanggalLahir"
                                    class="bg-transparent border border-[var(--txt-primary)]/30 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:border-[var(--bg-primary2)] block w-full p-2 ps-3"
                                    placeholder="Masukkan Tempat Tanggal Lahir" required value="Pamulang, 17 Agustus 1945" />
                            </div>
                            <div class="flex items-center justify-end mt-8">
