    ...
    <div class="mt-26 lg:mt-24">
      <div class="grid grid-cols-1 xl:grid-cols-[3fr_1fr] gap-4 lg:gap-8 mb-8">
        <div
          ...
          <p class="text-lg lg:text-2xl text-[var(--txt-primary)] mt-0 lg:mt-2">
            Ubah informasi Dokumen - administrator
          </p>
        </div>
      ...
      <div class="flex flex-col gap-8 mb-8">
        <form class="max-w-4xl" method="post" enctype="multipart/form-data">
          <div class="mb-5">
            <label for="id_dokumen" class="block mb-2 text-md md:text-lg font-medium text-[var(--txt-primary)]">
              ID Dokumen
            </label>
          ...
          <div class="mb-5">
            <label for="file_path" class="block mb-2 text-md md:text-lg font-medium text-[var(--txt-primary)]">
              File Path
            </label>
          ...
          <div class="mb-5">
            <label for="tanggal_upload" class="block mb-2 text-md md:text-lg font-medium text-[var(--txt-primary)]">
              Tanggal Upload
            </label>
            <input type="text" id="tanggal_upload" name="tanggal_upload"
              class="bg-transparent border border-[var(--txt-primary)]/50 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:bg-[var(--bg-primary2)]/10 focus:border-[var(--bg-primary2)] block w-full py-2.5 px-3.5"
              placeholder="Masukkan Tanggal Upload" value="<?php echo $data['tanggal_upload']; ?>" />
          </div>
          ...
          <div class="mb-5">
            ...
            <input type="text" id="catatan_admin" name="catatan_admin"
              class="bg-transparent border border-[var(--txt-primary)]/50 text-[var(--txt-primary)] text-md rounded-lg focus:ring-[var(--bg-primary2)] focus:bg-[var(--bg-primary2)]/10 focus:border-[var(--bg-primary2)] block w-full py-2.5 px-3.5"
              placeholder="Masukkan Catatan Admin" value="<?php echo $data['catatan_admin']; ?>" />
          </div>
          ...
          <div class="flex items-center justify-end mt-8 gap-3">
            ...
            <button type="submit" name="ubah_dokumen"
