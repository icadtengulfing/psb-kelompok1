            ...
            <div class="grid grid-cols-1 xl:grid-cols-[3fr_1fr] gap-4 lg:gap-8 mb-8">
                <div
                    ...
                    <p class="text-lg lg:text-2xl text-[var(--txt-primary)] mt-0 lg:mt-2">
                        Pendaftaran Melalui Jalur <span class="font-bold">Afirmasi</span>
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 my-6">
                        <div class="flex flex-col items-start justify-center w-full">
                            ...
                            <label for="KPIP"
                                ...
                                <input id="KPIP" type="file" class="hidden" name="KPIP"
                                    onchange="previewFileName('KPIP', 'previewKPIP')" />
                            </label>
                            <!-- Penampil nama file -->
                            <p id="previewKPIP" class="mt-2 text-sm text-[var(--txt-primary)]/70 italic">
                            </p>
                        </div>
                        <div class="flex flex-col items-start justify-center w-full">
                            <p class="font-semibold text-md mb-2">
                            ...
                            <label for="SKTM"
                                ...
                                <input id="SKTM" type="file" class="hidden" name="SKTM"
                                    onchange="previewFileName('SKTM', 'previewSKTM')" />
                            </label>
                            <!-- Penampil nama file -->
                            <p id="previewSKTM" class="mt-2 text-sm text-[var(--txt-primary)]/70 italic">
                            </p>
                        </div>
                        <div class="flex flex-col items-start justify-center w-full">
                            <p class="font-semibold text-md mb-2">Upload Surat Disabilitas</p>
                            <label for="disablitias"
                                class="flex flex-col items-center justify-center w-full h-40 border-2 border-[var(--bg-primary2)]/50 border-dashed rounded-lg cursor-pointer bg-transparent hover:bg-[var(--bg-primary2)]/10 transition duration-300">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg class="w-8 h-8 mb-4 text-[var(--txt-primary)]/50" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                ...
                                <input id="disablitias" type="file" class="hidden" name="disablitias"
                                    onchange="previewFileName('disablitias', 'previewDisablitias')" />
                            </label>
                            <!-- Penampil nama file -->
                            <p id="previewDisablitias" class="mt-2 text-sm text-[var(--txt-primary)]/70 italic"></p>
                        </div>
                    </div>
