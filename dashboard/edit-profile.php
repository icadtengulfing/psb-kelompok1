...
if (isset($_POST['update_data'])) {
    ...
    $update_query = "UPDATE pendaftar SET nama_lengkap_ortu = '$nama_lengkap_escaped', email = '$email_escaped' WHERE nik = '$nik_escaped'";
    
    if (mysqli_query($koneksi, $update_query)) {
        $message = "Data berhasil diperbarui!";
        $user_data['nama_lengkap_ortu'] = $nama_lengkap;
            ...
            <div class="grid grid-cols-1 xl:grid-cols-[3fr_1fr] gap-4 lg:gap-8 mb-8">
                <div
                    ...
                    <form class="w-full" method="post">
                        <h1 class="mb-6 text-xl md:text-4xl font-bold text-[var(--txt-primary)]">Data Umum</h1>
                        <div class="mb-6">
                            <label class="block mb-2 text-lg text-[var(--txt-primary)]" for="namaLengkap">Nama
                                Lengkap</label>
                            <input
                                ...
                                type="text" name="namaLengkap" id="namaLengkap" placeholder="Masukkan Nama Lengkap" value="<?php echo htmlspecialchars($user_data['nama_lengkap_ortu']); ?>">
                        </div>
                        <div class="mb-6">
                            <label class="block mb-2 text-lg text-[var(--txt-primary)]" for="email">Email</label>
                            <input
                                class="text-lg w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-[var(--bg-primary2)] bg-transparent text-[var(--txt-primary)]"
                                type="text" name="email" id="email" placeholder="Masukkan Email" value="<?php echo htmlspecialchars($user_data['email']); ?>">
                        </div>
                        <div class="mb-6">
                            <label class="block mb-2 text-lg text-[var(--txt-primary)]" for="nik">NIK</label>
                            <input
                                class="text-lg w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-[var(--bg-primary2)] bg-transparent text-[var(--txt-primary)]"
                                type="number" id="nik" placeholder="Masukkan NIK" value="<?php echo htmlspecialchars($nik); ?>">
                        </div>
                ...
                <div
                    ...
                    <a href="edit-profile.php"
                        class="flex items-center gap-2 lg:gap-4 w-full mb-5 bg-[var(--bg-primary2)]/20 hover:bg-[var(--bg-primary2)]/10 rounded-2xl shadow-sm transition duration-300 px-2 py-1">
                    ...
                    <a href="edit-profile-pwd.php"
                        class="flex items-center gap-2 lg:gap-4 w-full mb-5 hover:bg-[var(--bg-primary2)]/20 rounded-2xl hover:shadow-lg transition duration-300 p-3">
