...
<head>
    ...
    <title>Pendaftaran Murid Website SMK - PSB</title>
...
<body class="font-[inter] bg-[var(--bg-primary)]">
    ...
    <section class="p-4 lg:p-8 sm:ml-64">
        <div class="mt-26 lg:mt-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8 mb-8">
                <div
                    class="bg-[var(--bg-primary3)] rounded-xl shadow-lg border border-[var(--bg-primary2)]/20 hover:border-[var(--bg-primary2)]/80 transition duration-300">
                    <img src="../assets/img/card-jalur-pendaftaran/card-reguler.png" class="rounded-t-xl w-full"
                        alt="Image Jalur Register 1">
                    <div class="flex flex-col items-center px-4 mt-6">
                        <h1 class="uppercase text-xl lg:text-3xl font-bold text-[var(--txt-primary)]">
                            reguler
                        </h1>
                        <p class="text-[var(--txt-primary2)]/80 text-md my-6 text-center">Jalur pendaftaran utama bagi
                            seluruh calon peserta didik
                            yang memenuhi syarat umum tanpa pertimbangan khusus seperti prestasi atau kondisi tertentu.
                        </p>
                        <a href="reguler.php"
                            class="text-center w-full text-[var(--txt-secondary)] bg-[var(--bg-primary2)] hover:bg-[var(--bg-secondary4)] transition duration-300 focus:ring-3 focus:ring-[var(--bg-secondary)] font-bold rounded-lg text-lg lg:text-xl px-5 py-2.5 focus:outline-none cursor-pointer mb-4 shadow-md hover:shadow-lg">Daftar
                        </a>
                    </div>
                </div>
                <div
                    class="bg-[var(--bg-primary3)] rounded-xl shadow-lg border border-[var(--bg-primary2)]/20 hover:border-[var(--bg-primary2)]/80 transition duration-300">
                    <img src="../assets/img/card-jalur-pendaftaran/card-prestasi.png" class="rounded-t-xl w-full"
                        alt="Image Jalur Register 2">
                    <div class="flex flex-col items-center px-4 mt-6">
                        <h1 class="uppercase text-xl lg:text-3xl font-bold text-[var(--txt-primary)]">
                            PRESTASI
                        </h1>
                        <p class="text-[var(--txt-primary2)]/80 text-md my-6 text-center">
                            Diperuntukkan bagi calon peserta didik yang memiliki pencapaian akademik maupun
                            non-akademik, baik di tingkat sekolah, kabupaten, provinsi, maupun nasional.
                        </p>
                        <a href="prestasi.php"
                            class="text-center w-full text-[var(--txt-secondary)] bg-[var(--bg-primary2)] hover:bg-[var(--bg-secondary4)] transition duration-300 focus:ring-3 focus:ring-[var(--bg-secondary)] font-bold rounded-lg text-lg lg:text-xl px-5 py-2.5 focus:outline-none cursor-pointer mb-4 shadow-md hover:shadow-lg">Daftar
                        </a>
                ...
                <div
                    class="bg-[var(--bg-primary3)] rounded-xl shadow-lg border border-[var(--bg-primary2)]/20 hover:border-[var(--bg-primary2)]/80 transition duration-300">
                    <img src="../assets/img/card-jalur-pendaftaran/card-afirmasi.png" class="rounded-t-xl w-full"
                        alt="Image Jalur Register 3">
                    <div class="flex flex-col items-center px-4 mt-6">
                        <h1 class="uppercase text-xl lg:text-3xl font-bold text-[var(--txt-primary)]">
                            afirmasi
                        </h1>
                        <p class="text-[var(--txt-primary2)]/80 text-md my-6 text-center">Ditujukan bagi calon siswa
                            dari keluarga kurang mampu atau disabilitas, dengan melampirkan KIP, PKH, atau surat
                            keterangan resmi sebagai bukti pendukung.
                        </p>
                        <a href="afirmasi.php"
                            class="text-center w-full text-[var(--txt-secondary)] bg-[var(--bg-primary2)] hover:bg-[var(--bg-secondary4)] transition duration-300 focus:ring-3 focus:ring-[var(--bg-secondary)] font-bold rounded-lg text-lg lg:text-xl px-5 py-2.5 focus:outline-none cursor-pointer mb-4 shadow-md hover:shadow-lg">Daftar
                        </a>
