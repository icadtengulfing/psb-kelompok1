...
<head>
    ...
    <title>Reguler Pendaftaran Murid Website SMK - PSB</title>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-5 pb-4 overflow-y-auto bg-[var(--bg-primary3)]">
            ...
            <div
                ...
                <button type="button" onclick="window.location.href='./edit-profile.php'" 
    ...
    <section class="p-4 lg:p-8 sm:ml-64">
        <div class="mt-26 lg:mt-24">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-[1fr_2fr] gap-8 mb-8">
                <div
                    class="flex flex-col justify-center items-start p-4 lg:p-10 rounded-xl bg-[var(--bg-primary2)] border border-[var(--bg-primary2)]/30 shadow-md">
                    <div class="flex items-center">
                        <img src="../assets/img/logo-register-daftar-ds.png" class="h-15 2xl:h-auto"
                            alt="Image Daftar Reguler Dashboard">
                        <h1
                            class="text-xl lg:text-2xl xl:text-4xl font-semibold text-[var(--txt-secondary)] ms-3 lg:ms-8">
                            Daftar Melalui Jalur Reguler!
                        </h1>
                    </div>
                    <a href="form-pendaftaran/reguler.php"
                        class="text-center w-full text-[var(--txt-primary)] bg-[var(--bg-primary3)] hover:bg-[var(--bg-secondary2)] transition duration-300 focus:ring-3 focus:ring-[var(--bg-secondary)] font-bold rounded-lg text-lg lg:text-xl px-5 py-2.5 mt-6 focus:outline-none cursor-pointer">Daftar</a>
                </div>
                <div
