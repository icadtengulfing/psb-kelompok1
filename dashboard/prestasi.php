    ...
    <section class="p-4 lg:p-8 sm:ml-64">
        <div class="mt-26 lg:mt-24">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-[1fr_2fr] gap-8 mb-8">
                <div
                    class="flex flex-col justify-center items-start p-4 lg:p-10 rounded-xl bg-[var(--bg-secondary)] border border-[var(--bg-primary2)]/30 shadow-md">
                    <div class="flex items-center">
                        <img src="../assets/img/logo-prestasi-daftar-ds.png" class="h-15 2xl:h-auto"
                        ...
                        <h1
                            ...
                            Daftar Melalui Jalur Prestasi!
                        </h1>
                    </div>
                    <a href="form-pendaftaran/prestasi.php"
